...
function initModels(sequelize) {
  ...
  articles.belongsToMany(categories, {
    as: "categoryid_categories",
    through: articlecategories,
    foreignKey: "articleid",
    otherKey: "categoryid",
  });
  articles.belongsToMany(seokeywords, {
    as: "keywordid_seokeywords",
    through: articlekeywords,
    foreignKey: "articleid",
    otherKey: "keywordid",
  });
  brands.belongsToMany(categories, {
    as: "categoryid_categories_categorybrands",
    through: categorybrands,
    foreignKey: "brandid",
    otherKey: "categoryid",
  });
  categories.belongsToMany(articles, {
    as: "articleid_articles",
    through: articlecategories,
  ...
  categories.belongsToMany(mails, {
    as: "mailid_mails",
    through: categorymails,
    foreignKey: "categoryid",
    otherKey: "mailid",
  });
  mails.belongsToMany(categories, {
    as: "categoryid_categories_categorymails",
    through: categorymails,
    foreignKey: "mailid",
    otherKey: "categoryid",
  });
  seokeywords.belongsToMany(articles, {
    as: "articleid_articles_articlekeywords",
    through: articlekeywords,
  ...
  articlekeywords.belongsTo(articles, {
    as: "article",
    foreignKey: "articleid",
  });
  articles.hasMany(articlekeywords, {
    as: "articlekeywords",
    foreignKey: "articleid",
  });
  ...
  brands.hasMany(externalproducts, {
    as: "externalproducts",
    foreignKey: "brandid",
  });
  ...
  categorybrands.belongsTo(categories, {
    as: "category",
    foreignKey: "categoryid",
  });
  categories.hasMany(categorybrands, {
    as: "categorybrands",
    foreignKey: "categoryid",
  });
  categorymails.belongsTo(categories, {
    as: "category",
    foreignKey: "categoryid",
  });
  categories.hasMany(categorymails, {
    as: "categorymails",
    foreignKey: "categoryid",
  });
  ...
  articlekeywords.belongsTo(seokeywords, {
    as: "keyword",
    foreignKey: "keywordid",
  });
  seokeywords.hasMany(articlekeywords, {
    as: "articlekeywords",
    foreignKey: "keywordid",
  });
